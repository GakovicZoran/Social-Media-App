...
import { IFollow, IPosts, IUsers } from "../../Interfaces/Interfaces";
...
export const Posts = () => {
  ...
  const handlerPostChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    setTextPost(e.target.value);
  };
  const handlerUpload = async (e: React.MouseEvent<HTMLElement>) => {
    e.preventDefault();
    if (textPost === "") return;
  ...
  const matchPostID = (id: string) => {
    return following.find((userID: IFollow) => userID.uid === id);
  };
    ...
    <div className={postsContainer}>
      <div className={createPost}>
        ...
        <div className={imgPostBtnBox}>
          ...
          <button onClick={handlerUpload}>POST</button>
        </div>
      </div>
      <div className={userInfoContainer}>
        {posts.map(
          ({
            ...
            return ownerID === user?.uid || matchPostID(ownerID) ? (
